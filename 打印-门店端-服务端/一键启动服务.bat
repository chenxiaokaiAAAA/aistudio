...
REM 在新窗口中启动打印代理服务
start "打印代理服务" /D "%SCRIPT_DIR%" python print_proxy_server.py

REM 等待打印代理服务启动（给几秒时间）
timeout /t 3 /nobreak >nul

echo [2/2] 正在启动 FRP 客户端...
echo.
echo ========================================
echo  FRP 客户端连接信息
echo ========================================
