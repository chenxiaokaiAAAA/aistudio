...
def franchisee_coupons():
    ...
    for coupon in coupons:
        ...
        # 获取使用数量
        used_count = UserCoupon.query.filter_by(coupon_id=coupon.id, status="used").count()
        ...
        elif coupon.creator_type == "staf" and coupon.staff_user_id and StaffUser:
