...
def franchisee_permissions_list():
    ...
    for franchisee in franchisees:
        ...
        staff_users = []
        if StaffUser:
            staff_users = StaffUser.query.filter_by(franchisee_id=franchisee.id).order_by(StaffUser.created_at.desc()).all()
    ...
    return render_template('admin/franchisee_permissions_list.html',
