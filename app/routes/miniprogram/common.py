...
def get_helper_functions():
    ...
    test_server_module = sys.modules['test_server']
    return {
        'get_base_url': test_server_module.get_base_url if hasattr(test_server_module, 'get_base_url') else None,
        'get_media_url': test_server_module.get_media_url if hasattr(test_server_module, 'get_media_url') else None,
        'get_access_token': test_server_module.get_access_token if hasattr(test_server_module, 'get_access_token') else None,
        'send_order_completion_notification_auto': test_server_module.send_order_completion_notification_auto if hasattr(test_server_module, 'send_order_completion_notification_auto') else None
    }
