...
def record_share():
    ...
    try:
        ...
        share_record = ShareRecord(
            sharer_user_id=sharer_user_id, share_type=share_type, work_id=work_id, status="pending"
        )
...
def process_share_reward_impl(data):
    ...
    try:
        ...
        if share_record_id:
            ...
            # 通过作品ID查找最近的分享记录
            share_record = (
                ShareRecord.query.filter_by(work_id=work_id, status="pending")
        ...
        if not share_record:
            ...
            return {
                ...
                "data": {"sharer_reward": False, "shared_reward": False},
            }
